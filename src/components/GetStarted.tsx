  ...
  return (
    <div className={`w-full`}>
        ...
        <div className={`w-full flex  justify-center ${width < 1100 ? 'flex-col-reverse items-center' : 'items-start'}`}>
            <div className='w-full md:w-[450px] h-[480px] border rounded-md bg-[url(/images/features/find.jpg)] bg-cover bg-center bg-no-repeat relative my-4'>
                <div className={`md:w-[250px] h-[120px] absolute ${width < 1100 ? 'top-[280px] right-[10px] left-[10px]': '-right-36 -bottom-9'}   border rounded-md`}>
            ...
            <div className='w-full px-4 md:w-[480px] ml-16 md:px-4 my-4'>
                ...
                <ul className='w-full'>
                    <li className='flex items-center py-3'><AiOutlineCheck/> <p className='px-3'>Bring to the table win-win survival</p></li>
                    <li className='flex items-center py-3'><AiOutlineCheck/> <p className='px-3'>Capitalize on low hanging fruit to identify</p></li>
                    <li className='flex items-center py-3'><AiOutlineCheck/> <p className='px-3'>But i must explain to you how all this</p></li>
                </ul>
                <div className='pt-4'>
